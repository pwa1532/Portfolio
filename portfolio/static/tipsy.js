pv.Behavior.tipsy = function(opts) {
  ...
  return function(d) {
      ...
      if (this.properties.width) {
        tip.style.width = Math.ceil(this.width() * 1) + 1 + "px";
        tip.style.height = Math.ceil(this.height() * 1) + 1 + "px";
      ...
      tip.style.left = mouseX + 5;//Math.floor(this.left() * t.k + t.x) + "px";
      tip.style.top = mouseY;//Math.floor(this.top() * t.k + t.y) + "px";
